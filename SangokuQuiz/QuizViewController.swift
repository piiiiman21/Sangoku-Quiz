...
class QuizViewController: UIViewController {
    ...
    let url = Bundle.main.bundleURL.appendingPathComponent("Quiz-Correct_Answer02-1.mp3")
    let url2 = Bundle.main.bundleURL.appendingPathComponent("Quiz-Wrong_Buzzer02-1.mp3")
    ...
    func addBanerViewToView(_ bannerView: GADBannerView) {
